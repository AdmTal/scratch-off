...
class ScratchOff {
  ...
  private setup(): void {
    ...
    if (this.isDesktop) {
      ...
      this.scratchRadius = 36; // 6/5 of previous value (30) for larger scratch area on mobile
    }
  ...
  private playUnlockSound(): void {
    ...
    // Set gain to nearly silent but not zero (some browsers ignore zero)
  ...
  private createTouchCursorElement(): HTMLDivElement {
    ...
    // Mobile coin cursor size (77x77 = 4/5 of previous 96x96), scratch radius is set separately
